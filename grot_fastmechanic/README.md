...
- `client.lua` - Główny silnik logiczny odpowiadający za fetching i nakładanie modyfikacji (FiveM Natives), zarządzający zdarzeniami aparatu pojazdu (Pochylenie/Szerokość), przechwytujący wejście NUI callback poprzez F6 i blipy mapy. Posiada system cache dla powracającego Handlingu.
